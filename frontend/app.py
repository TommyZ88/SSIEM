...
@app.route('/') # Default Page link localhost:5000
def hello_world():
    return 'Hello, World!'

@app.route('/test_es') # Elastic Search connection test Page
...
@app.route('/management') #account management page /mangament
def management():
    return render_template('management.html')

@app.route('/addUser') #Adding user to accounts database /addUser
def addUser():
